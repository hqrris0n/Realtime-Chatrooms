...
const Sidebar = () => {
  ...
  return (
    <aside className="flex flex-col w-20 h-full overflow-auto transition-all duration-200 border-r lg:w-72 border-base-300">
      <div className="w-full border-b border-base-300">
        ...
        <div className="items-center hidden gap-2 my-1 ml-3 lg:flex">
